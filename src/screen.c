...
void (*flipbasecolfunc)(void); // vertically flipped
void (*fuzzcolfunc)(void); // standard fuzzy effect column drawer
void (*flipfuzzcolfunc)(void); // vertically flipped
void (*transcolfunc)(void); // translation column drawer
void (*fliptranscolfunc)(void); // vertically flipped
...
void (*fliptranstransfunc)(void); // vertically flipped
...
void SCR_SetMode(void)
{
	...
	if (vid.bpp == 1)
	{
		...
		fliptranscolfunc = R_DrawFlippedTranslatedColumn_8;
		transtransfunc = R_DrawTranslatedTranslucentColumn_8;
		fliptranstransfunc = R_DrawFlippedTranslatedTranslucentColumn_8;

		colfunc = basecolfunc = R_DrawColumn_8;
		flipbasecolfunc = R_DrawFlippedColumn_8;
		shadecolfunc = R_DrawShadeColumn_8;
		fuzzcolfunc = R_DrawTranslucentColumn_8;
		flipfuzzcolfunc = R_DrawFlippedTranslucentColumn_8;
