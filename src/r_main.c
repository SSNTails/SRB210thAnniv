...
consvar_t cv_removehud = {"removehud", "No", CV_CALL,  CV_YesNo, R_SetViewSize, 0, NULL, NULL, 0, 0, NULL};
...
void R_RenderPlayerView(player_t *player)
{
	...
	if (player == &players[displayplayer] && cv_homremoval.value) // if this is display player 1
