...
typedef enum
{
	...
	FF_RIPPLE            = 0x10000000,///< Ripple the flats
	FF_COLORMAPONLY      = 0x20000000,///< Only copy the colormap, not the lightlevel
	FF_UNUSED2           = 0x40000000,///< Unused 2
	FF_UNUSED3           = 0x80000000,///< Unused 3
} ffloortype_e;
...
typedef enum
{
	FLIPSPECIAL_FLOORONLY = 0,
	FLIPSPECIAL_CEILONLY,
	FLIPSPECIAL_BOTH,
} flipspecial_t;
